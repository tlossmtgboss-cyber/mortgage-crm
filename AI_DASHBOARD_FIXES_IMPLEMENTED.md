...
curl -X POST "https://api.perenniaai.com/api/v1/ai-receptionist/dashboard/admin/aggregate-metrics?days=30" \
...
curl -X POST "https://api.perenniaai.com/api/v1/ai-receptionist/dashboard/admin/aggregate-metrics?days=1" \
  -H "Authorization: Bearer YOUR_TOKEN"
```
