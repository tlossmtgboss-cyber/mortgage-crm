...
curl -H "Authorization: Bearer YOUR_TOKEN" \
  https://api.perenniaai.com/api/v1/ai-receptionist/dashboard/metrics/realtime

# Get ROI
curl -H "Authorization: Bearer YOUR_TOKEN" \
  https://api.perenniaai.com/api/v1/ai-receptionist/dashboard/roi

# Get skills performance
curl -H "Authorization: Bearer YOUR_TOKEN" \
  https://api.perenniaai.com/api/v1/ai-receptionist/dashboard/skills

# Get system health
curl -H "Authorization: Bearer YOUR_TOKEN" \
  https://api.perenniaai.com/api/v1/ai-receptionist/dashboard/system-health

# Get conversations
curl -H "Authorization: Bearer YOUR_TOKEN" \
  https://api.perenniaai.com/api/v1/ai-receptionist/dashboard/conversations
```
...
**Dashboard API:** https://api.perenniaai.com/api/v1/ai-receptionist/dashboard
