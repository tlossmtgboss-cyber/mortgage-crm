...
```
Correct URL: https://app.perenniaai.com/api/v1/voice/incoming
Method: POST
```
...
- Twilio sends webhook to: `https://app.perenniaai.com/api/v1/voice/incoming`
...
```bash
curl -X DELETE \
  "https://app.perenniaai.com/api/v1/ai-receptionist/dashboard/admin/clear-sample-data" \
...
| Webhook URL | ✅ Fixed | `https://app.perenniaai.com/api/v1/voice/incoming` |
...
3. **Test webhook directly:**
   ```bash
   curl -X POST "https://app.perenniaai.com/api/v1/voice/incoming" \
     -d "From=+15555551234" \
     -d "To=+18326482297" \
     -d "CallSid=TEST123"
   ```
