...
2. Add webhook URL:
   ```
   https://app.perenniaai.com/api/vapi/webhook
   ```
3. Select events:
   - ✅ `call.started`
   - ✅ `call.ended`
...
### Test Vapi webhook:
```bash
curl -X POST https://app.perenniaai.com/api/vapi/webhook \
...
- Check webhook URL: `https://app.perenniaai.com/api/vapi/webhook`
