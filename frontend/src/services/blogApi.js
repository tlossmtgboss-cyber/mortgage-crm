...
export const createVoiceProfile = async (data) => {
  const response = await axios.post(`${API_BASE}/voice-profiles`, data);
  return response.data;
};

export const updateVoiceProfile = async (profileId, data) => {
  const response = await axios.put(`${API_BASE}/voice-profiles/${profileId}`, data);
  return response.data;
};

export const deleteVoiceProfile = async (profileId) => {
  const response = await axios.delete(`${API_BASE}/voice-profiles/${profileId}`);
  return response.data;
};
...
export const getComplianceProfiles = async (activeOnly = true) => {
  const response = await axios.get(`${API_BASE}/compliance-profiles`, {
    params: { active_only: activeOnly }
  });
  return response.data;
};
...
export const createComplianceProfile = async (data) => {
  const response = await axios.post(`${API_BASE}/compliance-profiles`, data);
  return response.data;
};
...
export const getSourceDocuments = async (processedOnly = false) => {
  const response = await axios.get(`${API_BASE}/source-documents`, {
...
export const uploadSourceDocument = async (file, title, author, rightsAttestation) => {
  ...
  const response = await axios.post(`${API_BASE}/source-documents/upload`, formData, {
...
export const getSourceDocument = async (docId) => {
  const response = await axios.get(`${API_BASE}/source-documents/${docId}`);
  return response.data;
};
...
export const createCampaign = async (data) => {
  const response = await axios.post(`${API_BASE}/campaigns`, data);
  return response.data;
};
...
export const generateContent = async (data) => {
  const response = await axios.post(`${API_BASE}/content/generate`, data);
  return response.data;
};
...
export const updateContent = async (contentId, data) => {
  const response = await axios.put(`${API_BASE}/content/${contentId}`, data);
  return response.data;
};

export const deleteContent = async (contentId) => {
  const response = await axios.delete(`${API_BASE}/content/${contentId}`);
  return response.data;
};
...
export const mineTopics = async (sourceDocumentId, count = 10, campaignId = null) => {
  const response = await axios.post(`${API_BASE}/topics/mine`, {
...
export const checkCompliance = async (content, complianceProfileId = null) => {
  ...
  const response = await axios.post(`${API_BASE}/compliance/check`, formData);
  return response.data;
};
...
export const checkSimilarity = async (content, sourceDocumentId = null) => {
  ...
  const response = await axios.post(`${API_BASE}/similarity/check`, formData);
  return response.data;
};
...
export const updateUserSettings = async (data) => {
  const response = await axios.put(`${API_BASE}/settings`, data);
  return response.data;
};
...
export const getContentPerformance = async (contentId) => {
  const response = await axios.get(`${API_BASE}/content/${contentId}/performance`);
  return response.data;
};
