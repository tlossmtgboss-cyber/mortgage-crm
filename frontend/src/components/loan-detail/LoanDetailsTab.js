...
/**
 * Loan Details tab — transaction type, loan terms, financial details,
 * ARM details, present vs proposed housing, and 2nd loan details.
 */
function LoanDetailsTab({ formData, handleFieldChange }) {
  return (
