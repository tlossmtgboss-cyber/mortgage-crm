...
const WHISPER_TYPES = {
  ...
  product_recommendation: { icon: '📦', label: 'Recommend Product', color: '#8b5cf6' },
  compliance_reminder: { icon: '⚖️', label: 'Compliance', color: '#f59e0b' },
  next_action: { icon: '➡️', label: 'Next Step', color: '#10b981' },
  rate_info: { icon: '📊', label: 'Rate Info', color: '#06b6d4' },
  question_prompt: { icon: '❓', label: 'Ask This', color: '#6366f1' },
