        ...
        <div className="funding-grid">
          ...
          <div className="funding-table-container">
            <table className="funding-table">
              ...
              <tbody>
                <tr>
                  <td className="label">Total Calls</td>
                  <td>{formatNumber(data.call_activity?.total_calls || 0)}</td>
                </tr>
                <tr>
                  <td className="label">Calls Answered</td>
                  <td>{formatNumber(data.call_activity?.calls_answered || 0)}</td>
                </tr>
                <tr>
                  <td className="label">Voicemails Left</td>
                  <td>{formatNumber(data.call_activity?.voicemails_left || 0)}</td>
                </tr>
                <tr>
                  <td className="label">Connect Rate</td>
                  <td>{data.call_activity?.connect_rate || 0}%</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="funding-table-container">
            <table className="funding-table">
              ...
              <tbody>
                <tr>
                  <td className="label">Avg Call Duration</td>
                  <td>{data.call_activity?.avg_duration || '0:00'}</td>
                </tr>
                <tr>
                  <td className="label">Total Talk Time</td>
                  <td>{data.call_activity?.total_talk_time || '0:00'}</td>
                </tr>
                <tr>
                  <td className="label">Longest Call</td>
                  <td>{data.call_activity?.longest_call || '0:00'}</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="funding-table-container">
            <table className="funding-table">
              ...
              <tbody>
                {data.call_activity?.outcomes ? (
                  data.call_activity.outcomes.map((outcome, index) => (
                    <tr key={index}>
                      <td>{outcome.type}</td>
                      <td>{outcome.count}</td>
