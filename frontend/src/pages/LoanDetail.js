...
import { SLADatesTab, ConversationLogTab, ConditionsTab, TeamMembersTab, CircleTab } from './loan-detail';
  ...
  const loadLoansList = async () => {
    try {
      ...
      try {
        ...
        console.error('Failed to load loans list:', apiError);
        loans = [];
      }
      setLoansList(loans);
  ...
  const loadLoanData = async () => {
    try {
      ...
      try {
        ...
        console.error('Failed to load loan:', apiError);
        const errorMessage = apiError?.response?.data?.detail || apiError?.message || 'Failed to load loan details';
      ...
      <div className="detail-content">
        ...
        {activeTab === 'team' && (
          <TeamMembersTab
            ...
            showTeamMemberSearchResults={showTeamMemberSearchResults}
            setShowTeamMemberSearchResults={setShowTeamMemberSearchResults}
            teamMemberSearchLoading={teamMemberSearchLoading}
            ...
            handleTeamMemberNameChange={handleTeamMemberNameChange}
            selectTeamMemberSearchResult={selectTeamMemberSearchResult}
          />
        )}
        ...
        {activeTab === 'circle' && (
          <CircleTab
            ...
            circleContactTypes={circleContactTypes}
            ...
            handleAddCircleContactSubmit={handleAddCircleContactSubmit}
            handleDeleteCircleContact={handleDeleteCircleContact}
            handleEditCircleContact={handleEditCircleContact}
        ...
        {activeTab === 'important-dates' && (
          <SLADatesTab formData={formData} onFieldChange={handleFieldChange} />
        )}
