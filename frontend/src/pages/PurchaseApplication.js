  ...
  const renderScheduleStage = () => {
    ...
    return (
      <div className="stage-content scheduling-page">
        ...
        {/* E-Consent Section */}
        <div className="econsent-section">
          <div className="econsent-header">
            <Icon name="shield" size={24} />
            <h3>E-Consent Documentation</h3>
          </div>
          ...
          <div className="econsent-content">
            ...
            <div className="econsent-scrollbox">
              ...
              <p>
                ...
                consent, You can do so by clicking on the 'I do not agree' button, or by notifying Us at:
              </p>
              <div className="econsent-contact">
                <p><strong>Phone:</strong> (843) 834-4997</p>
                <p><strong>Address:</strong> 3160 Crow Canyon Road, Suite #400, San Ramon, CA 94583</p>
              </div>
              <p>
              ...
              <p>
                After Your consent is given, You may request from Us paper copies of Your Loan Documents. Please
                send this request to Us at:
              </p>
              <div className="econsent-contact">
                <p><strong>Phone:</strong> (843) 834-4997</p>
                <p><strong>Address:</strong> 3160 Crow Canyon Road, Suite #400, San Ramon, CA 94583</p>
              ...
              <p>
                If You request paper copies of the Loan Documents:
            ...
            <div className="econsent-actions">
              ...
              <button
                className={`econsent-btn disagree ${eConsentAgreed === false && eConsentAgreed !== null ? '' : ''}`}
                onClick={() => {
