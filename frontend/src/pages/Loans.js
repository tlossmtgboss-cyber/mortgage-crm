...
// Team: LO=Timothy Loss, Processor=Jessica Marlow, PAs=Michael Santos/Lauren Carter, UWs=Danielle Brooks/Samuel Price/Helen Rogers/Kelvin Abdul/Patricia Donovan
const generateMockLoans = () => {
  return [
    // ========== ACTIVE PIPELINE LOANS (from 30 scenarios) ==========

    // In Processing (6 loans)
    { id: 3, borrower_name: 'Sandra & Robert Chen', borrower: 'Sandra & Robert Chen', amount: 650000, property_address: '4521 Preston Hollow Ln, Dallas TX 75225', stage: 'In Processing', days_in_process: 15, loan_officer: 'Timothy Loss', processor: 'Jessica Marlow', production_assistant: 'Michael Santos', rate_locked: false, lock_guidance: 'Float Cautious', lock_confidence: 72, loan_number: 'TST-0003', program: 'Conventional 30yr Fixed' },
    { id: 4, borrower_name: 'Angela Martinez', borrower: 'Angela Martinez', amount: 380000, property_address: '789 Freedom Dr, Fort Worth TX 76109', stage: 'In Processing', days_in_process: 20, loan_officer: 'Timothy Loss', processor: 'Jessica Marlow', production_assistant: 'Lauren Carter', rate_locked: true, loan_number: 'TST-0004', program: 'VA 30yr Fixed' },
    { id: 13, borrower_name: 'Brian & Stephanie Cooper', borrower: 'Brian & Stephanie Cooper', amount: 950000, property_address: '12345 Highland Park Blvd, Dallas TX 75205', stage: 'In Processing', days_in_process: 10, loan_officer: 'Timothy Loss', processor: 'Jessica Marlow', production_assistant: 'Michael Santos', rate_locked: false, lock_guidance: 'Lock Now', lock_confidence: 88, loan_number: 'TST-0013', program: 'Jumbo 30yr ARM' },
    { id: 17, borrower_name: 'Elizabeth & Anthony Cruz', borrower: 'Elizabeth & Anthony Cruz', amount: 265000, property_address: '2468 Commerce St, Garland TX 75040', stage: 'In Processing', days_in_process: 8, loan_officer: 'Timothy Loss', processor: 'Jessica Marlow', production_assistant: 'Michael Santos', rate_locked: false, lock_guidance: 'Float Cautious', lock_confidence: 68, loan_number: 'TST-0017', program: 'FHA 30yr Fixed' },
    { id: 21, borrower_name: 'Daniel Kim', borrower: 'Daniel Kim', amount: 375000, property_address: '7654 Preston Rd, Dallas TX 75230', stage: 'In Processing', days_in_process: 14, loan_officer: 'Timothy Loss', processor: 'Jessica Marlow', production_assistant: 'Michael Santos', rate_locked: true, loan_number: 'TST-0021', program: 'Conventional 30yr Fixed' },
    { id: 25, borrower_name: 'Victoria & Jason Wright', borrower: 'Victoria & Jason Wright', amount: 425000, property_address: '1357 Forest Lane, Coppell TX 75019', stage: 'In Processing', days_in_process: 7, loan_officer: 'Timothy Loss', processor: 'Jessica Marlow', production_assistant: 'Lauren Carter', rate_locked: false, lock_guidance: 'Lock Soon', lock_confidence: 78, loan_number: 'TST-0025', program: 'Conventional 30yr Fixed' },

    // Conditional Approval / Approved (5 loans)
    { id: 5, borrower_name: 'David & Patricia Thompson', borrower: 'David & Patricia Thompson', amount: 425000, property_address: '2345 Mockingbird Ln, Richardson TX 75080', stage: 'Approved', days_in_process: 25, loan_officer: 'Timothy Loss', processor: 'Jessica Marlow', production_assistant: 'Michael Santos', underwriter: 'Danielle Brooks', rate_locked: true, loan_number: 'TST-0005', program: 'Conventional 15yr Fixed' },
    { id: 6, borrower_name: "Michael O'Brien", borrower: "Michael O'Brien", amount: 320000, property_address: '567 Oak Ridge Blvd, Plano TX 75024', stage: 'Approved', days_in_process: 28, loan_officer: 'Timothy Loss', processor: 'Jessica Marlow', production_assistant: 'Lauren Carter', underwriter: 'Samuel Price', rate_locked: true, loan_number: 'TST-0006', program: 'Conventional 30yr Fixed' },
    { id: 14, borrower_name: 'Kevin & Laura Mitchell', borrower: 'Kevin & Laura Mitchell', amount: 290000, property_address: '4567 Cedar Springs, Lewisville TX 75067', stage: 'Approved', days_in_process: 22, loan_officer: 'Timothy Loss', processor: 'Jessica Marlow', production_assistant: 'Michael Santos', underwriter: 'Helen Rogers', rate_locked: true, loan_number: 'TST-0014', program: 'Conventional 30yr Fixed' },
    { id: 19, borrower_name: 'Catherine & Paul Newman', borrower: 'Catherine & Paul Newman', amount: 565000, property_address: '9012 Stonebriar Pkwy, Frisco TX 75035', stage: 'Approved', days_in_process: 30, loan_officer: 'Timothy Loss', processor: 'Jessica Marlow', production_assistant: 'Michael Santos', underwriter: 'Patricia Donovan', rate_locked: true, loan_number: 'TST-0019', program: 'Conventional 30yr Fixed' },
    { id: 29, borrower_name: 'Samantha & Eric Clark', borrower: 'Samantha & Eric Clark', amount: 355000, property_address: '6543 Lakewood Blvd, Dallas TX 75214', stage: 'Approved', days_in_process: 18, loan_officer: 'Timothy Loss', processor: 'Jessica Marlow', production_assistant: 'Lauren Carter', underwriter: 'Danielle Brooks', rate_locked: true, loan_number: 'TST-0029', program: 'Conventional 30yr Fixed' },

    // Clear to Close (3 loans)
    { id: 7, borrower_name: 'Jennifer & William Park', borrower: 'Jennifer & William Park', amount: 515000, property_address: '8901 Legacy Dr, Frisco TX 75034', stage: 'Clear to Close', days_in_process: 35, loan_officer: 'Timothy Loss', processor: 'Jessica Marlow', production_assistant: 'Michael Santos', underwriter: 'Helen Rogers', rate_locked: true, loan_number: 'TST-0007', program: 'Conventional 30yr Fixed' },
    { id: 8, borrower_name: 'Christopher & Maria Santos', borrower: 'Christopher & Maria Santos', amount: 295000, property_address: '1234 Bluebonnet Way, Arlington TX 76011', stage: 'Clear to Close', days_in_process: 32, loan_officer: 'Timothy Loss', processor: 'Jessica Marlow', production_assistant: 'Michael Santos', underwriter: 'Kelvin Abdul', rate_locked: true, loan_number: 'TST-0008', program: 'FHA 30yr Fixed' },
    { id: 22, borrower_name: 'Jessica & Andrew Moore', borrower: 'Jessica & Andrew Moore', amount: 435000, property_address: '5432 Turtle Creek Blvd, Dallas TX 75219', stage: 'Clear to Close', days_in_process: 38, loan_officer: 'Timothy Loss', processor: 'Jessica Marlow', production_assistant: 'Lauren Carter', underwriter: 'Samuel Price', rate_locked: true, loan_number: 'TST-0022', program: 'Conventional 30yr Fixed' },

    // Suspended (2 loans)
    { id: 9, borrower_name: 'Rachel Green', borrower: 'Rachel Green', amount: 445000, property_address: '5678 Park Lane, McKinney TX 75070', stage: 'Suspended', days_in_process: 45, loan_officer: 'Timothy Loss', processor: 'Jessica Marlow', production_assistant: 'Lauren Carter', underwriter: 'Patricia Donovan', rate_locked: false, lock_guidance: 'Lock Now', lock_confidence: 85, loan_number: 'TST-0009', program: 'Conventional 30yr Fixed' },
    { id: 26, borrower_name: 'Nathan & Olivia Hall', borrower: 'Nathan & Olivia Hall', amount: 395000, property_address: '2468 Hillcrest Ave, University Park TX 75205', stage: 'Suspended', days_in_process: 40, loan_officer: 'Timothy Loss', processor: 'Jessica Marlow', production_assistant: 'Michael Santos', underwriter: 'Kelvin Abdul', rate_locked: true, loan_number: 'TST-0026', program: 'Conventional 30yr Fixed' },

    // ========== FUNDED LOANS (MUM Clients) ==========
    { id: 10, borrower_name: 'James & Linda Foster', borrower: 'James & Linda Foster', amount: 385000, property_address: '3456 Maple Ave, Carrollton TX 75007', stage: 'Funded This Month', days_in_process: 28, loan_officer: 'Timothy Loss', processor: 'Jessica Marlow', underwriter: 'Danielle Brooks', rate_locked: true, funded_date: '2025-02-28', loan_number: 'TST-0010', program: 'Conventional 30yr Fixed' },
    { id: 11, borrower_name: 'Steven & Amanda Rodriguez', borrower: 'Steven & Amanda Rodriguez', amount: 520000, property_address: '7890 Veterans Pkwy, Irving TX 75039', stage: 'Funded Prior Month', days_in_process: 30, loan_officer: 'Timothy Loss', processor: 'Jessica Marlow', underwriter: 'Samuel Price', rate_locked: true, funded_date: '2025-02-05', loan_number: 'TST-0011', program: 'VA 30yr Fixed' },
    { id: 16, borrower_name: 'Robert & Michelle Turner', borrower: 'Robert & Michelle Turner', amount: 475000, property_address: '6789 Southlake Blvd, Southlake TX 76092', stage: 'Funded Prior Month', days_in_process: 32, loan_officer: 'Timothy Loss', processor: 'Jessica Marlow', underwriter: 'Kelvin Abdul', rate_locked: true, funded_date: '2025-01-10', loan_number: 'TST-0016', program: 'Conventional 30yr Fixed' },
    { id: 20, borrower_name: 'Timothy & Rebecca Adams', borrower: 'Timothy & Rebecca Adams', amount: 340000, property_address: '3579 Meadowbrook Dr, Colleyville TX 76034', stage: 'Funded Prior Month', days_in_process: 27, loan_officer: 'Timothy Loss', processor: 'Jessica Marlow', underwriter: 'Danielle Brooks', rate_locked: true, funded_date: '2024-12-05', loan_number: 'TST-0020', program: 'Conventional 15yr Fixed' },
    { id: 24, borrower_name: 'Mark & Christine Evans', borrower: 'Mark & Christine Evans', amount: 285000, property_address: '8765 Westover Hills, Fort Worth TX 76116', stage: 'Funded Prior Month', days_in_process: 29, loan_officer: 'Timothy Loss', processor: 'Jessica Marlow', underwriter: 'Helen Rogers', rate_locked: true, funded_date: '2024-10-28', loan_number: 'TST-0024', program: 'FHA 30yr Fixed' },
    { id: 28, borrower_name: 'Richard & Emily Scott', borrower: 'Richard & Emily Scott', amount: 875000, property_address: '4321 Westlake Dr, Westlake TX 76262', stage: 'Funded Prior Month', days_in_process: 35, loan_officer: 'Timothy Loss', processor: 'Jessica Marlow', underwriter: 'Patricia Donovan', rate_locked: true, funded_date: '2024-10-15', loan_number: 'TST-0028', program: 'Jumbo 30yr Fixed' },
  ];
};
