...
export const AVAILABLE_INTEGRATIONS = [
  ...
  { id: 'synthflow', name: 'Synthflow AI', description: 'AI-powered voice agents for automated client calls and lead qualification', icon: '', color: '#1F3D2E', category: 'AI & Automation' },
  { id: 'recallai', name: 'Recall.ai', description: 'Record and transcribe meetings from Zoom, Teams, and Google Meet with AI', icon: '', color: '#2D7A52', category: 'AI & Automation' },
...
export const STATUS_BADGE_STYLES = {
  ...
  'Sent': { background: '#F5EDD9', color: '#3730a3' },
  ...
  'Started': { background: '#F5EDD9', color: '#3730a3' },
