...
1. **URL:** Paste this exactly:
   ```
   https://app.perenniaai.com/api/v1/leads/
   ```
...
2. **URL:**
   ```
   https://app.perenniaai.com/api/v1/leads/{{LEAD_ID}}
   ```
...
1. **URL:**
   ```
   https://app.perenniaai.com/api/v1/leads?limit=100
   ```
...
3. Verify the URL is exactly: `https://app.perenniaai.com/api/v1/leads/`
...
- Event: POST
- URL: `https://app.perenniaai.com/api/v1/leads/`
