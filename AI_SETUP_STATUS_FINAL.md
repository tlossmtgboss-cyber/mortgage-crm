...
- ✅ Health endpoint responding: https://app.perenniaai.com/health
...
3. **Then run migration:**
   ```bash
   curl -X POST 'https://app.perenniaai.com/admin/run-ai-migration' \
...
3. **Then initialize:**
   ```bash
   curl -X POST 'https://app.perenniaai.com/admin/initialize-ai-system' \
     -H 'Content-Type: application/json' \
     -d '{"secret": "migrate-ai-2024"}'
   ```
