...
def register_inline_routes(app, get_db, get_current_user, get_current_user_flexible, **kwargs):
    ...
    # Block delegated to inline_legacy/extracted_modules.py — mechanical move only.
    from routes.inline_legacy.extracted_modules import register_extracted_modules
    _extracted_exports = register_extracted_modules(
    ...
    if _extracted_exports:
        _exported_functions.update(_extracted_exports)
