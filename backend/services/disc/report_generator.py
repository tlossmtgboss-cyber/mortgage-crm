...
assessment report format (Perennia AI branded).
"""
...
class DISCReportGenerator:
    ...
    def _build_cover_page(self, data: ReportData) -> list:
        ...
        elements.append(Paragraph("Perennia AI", self.styles['ReportTitle']))
    ...
    def _build_summary_section(self, data: ReportData) -> list:
        ...
        # Report footer
        elements.append(Paragraph(
            f"Report generated by Perennia AI on {datetime.now().strftime('%B %d, %Y')}",
            ParagraphStyle(
                'Footer',
                parent=self.styles['Normal'],
                fontSize=10,
