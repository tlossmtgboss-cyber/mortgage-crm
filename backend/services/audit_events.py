"""
Audit Events Service — SOC 2 Breadcrumb Trail

Complements audit_service.py (hash-chained detailed change tracking) with
lightweight event-type-based breadcrumbs for every mutating API call.
...
Writes are non-blocking — failures log loudly but never fail the request.
"""
...
def audit_event(
    ...
    *,
    ...
    """
    Persist an audit event. Fire-and-forget from caller's perspective —
