...
class WeeklyDigestService:
    ...
    def format_html_email(self, digest: Dict[str, Any]) -> str:
        ...
        <body>
            <div class="container">
                <div class="header">
                    <h1>Pipeline 360 Profitability Insights</h1>
...
{digest.get('content', 'No insights available.')}
                ...
                <div class="footer">
                    <p>Generated by Pipeline 360 AI | {datetime.now().strftime('%B %d, %Y at %I:%M %p')}</p>
                    <p><a href="https://mortgage-crm-nine.vercel.app/profitability">View Full Dashboard</a></p>
                </div>
            </div>
        </body>
        </html>
