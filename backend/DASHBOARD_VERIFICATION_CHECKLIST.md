...
#### Activity Feed
```bash
curl "https://app.perenniaai.com/api/v1/ai-receptionist/dashboard/activity/feed?limit=5" \
  -H "Authorization: Bearer YOUR_TOKEN"
```
...
#### Realtime Metrics
```bash
curl "https://app.perenniaai.com/api/v1/ai-receptionist/dashboard/metrics/realtime" \
  -H "Authorization: Bearer YOUR_TOKEN"
```
...
#### Daily Metrics
```bash
curl "https://app.perenniaai.com/api/v1/ai-receptionist/dashboard/metrics/daily?start_date=2024-11-01&end_date=2024-11-15" \
  -H "Authorization: Bearer YOUR_TOKEN"
```
...
#### Skills
```bash
curl "https://app.perenniaai.com/api/v1/ai-receptionist/dashboard/skills" \
  -H "Authorization: Bearer YOUR_TOKEN"
```
...
#### ROI
```bash
curl "https://app.perenniaai.com/api/v1/ai-receptionist/dashboard/roi" \
  -H "Authorization: Bearer YOUR_TOKEN"
```
...
#### Errors
```bash
curl "https://app.perenniaai.com/api/v1/ai-receptionist/dashboard/errors?status=unresolved" \
  -H "Authorization: Bearer YOUR_TOKEN"
```
...
#### System Health
```bash
curl "https://app.perenniaai.com/api/v1/ai-receptionist/dashboard/system-health" \
  -H "Authorization: Bearer YOUR_TOKEN"
```
...
```bash
curl "https://app.perenniaai.com/api/v1/ai-receptionist/dashboard/errors?limit=1" \
  -H "Authorization: Bearer YOUR_TOKEN"
```

**Approve the fix:**
```bash
curl -X POST "https://app.perenniaai.com/api/v1/ai-receptionist/dashboard/errors/{ERROR_ID}/approve-fix" \
  -H "Authorization: Bearer YOUR_TOKEN"
```
...
```bash
curl "https://app.perenniaai.com/api/v1/ai-receptionist/dashboard/metrics/daily?start_date=2025-12-31&end_date=2025-01-01" \
  -H "Authorization: Bearer YOUR_TOKEN"
```
...
```bash
curl -X POST "https://app.perenniaai.com/api/v1/ai-receptionist/dashboard/errors/nonexistent-id/approve-fix" \
  -H "Authorization: Bearer YOUR_TOKEN"
```
...
```bash
curl "https://app.perenniaai.com/api/v1/ai-receptionist/dashboard/skills/NonExistentSkill" \
  -H "Authorization: Bearer YOUR_TOKEN"
```
**Expected:** 404 Not Found
```json
...
```bash
curl "https://app.perenniaai.com/api/v1/ai-receptionist/dashboard/activity/feed"
```
...
**Questions or issues?**
- Check API docs: https://app.perenniaai.com/docs#/AI%20Receptionist%20Dashboard
