...
class EmailFilterWhitelist(Base):
    ...
    description = Column(String(500))
    whitelist_type = Column(Enum("email", "domain", "pattern", name="whitelist_type_enum"), default="email")
...
class EmailFilterBlacklist(Base):
    ...
    email_pattern = Column(String(255), nullable=False, index=True)
    description = Column(String(500))
    blacklist_type = Column(Enum("email", "domain", "pattern", name="blacklist_type_enum"), default="email")
