...
class MilestoneType(str, enum.Enum):
    ...
    HAZARD_INSURANCE_ORDERED = "hazard_insurance_ordered"
    HAZARD_INSURANCE_RECEIVED = "hazard_insurance_received"
    FLOOD_INSURANCE_ORDERED = "flood_insurance_ordered"
    FLOOD_INSURANCE_RECEIVED = "flood_insurance_received"
