...
curl -X GET "https://app.perenniaai.com/api/v1/ai-receptionist/dashboard/activity/feed?limit=5" \
  -H "Authorization: Bearer YOUR_TOKEN"

# Test 2: Realtime Metrics (should return 200 with metrics)
curl -X GET "https://app.perenniaai.com/api/v1/ai-receptionist/dashboard/metrics/realtime" \
  -H "Authorization: Bearer YOUR_TOKEN"

# Test 3: Skills (should return 200 with skills array)
curl -X GET "https://app.perenniaai.com/api/v1/ai-receptionist/dashboard/skills" \
  -H "Authorization: Bearer YOUR_TOKEN"

# Test 4: ROI (should return 200 with ROI calculations)
curl -X GET "https://app.perenniaai.com/api/v1/ai-receptionist/dashboard/roi" \
  -H "Authorization: Bearer YOUR_TOKEN"

# Test 5: Errors (should return 200 with errors array)
curl -X GET "https://app.perenniaai.com/api/v1/ai-receptionist/dashboard/errors" \
  -H "Authorization: Bearer YOUR_TOKEN"

# Test 6: System Health (should return 200 with health data)
curl -X GET "https://app.perenniaai.com/api/v1/ai-receptionist/dashboard/system-health" \
  -H "Authorization: Bearer YOUR_TOKEN"
```
