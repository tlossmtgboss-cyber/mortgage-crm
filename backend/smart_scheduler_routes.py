...
async def get_email_service_status():
    ...
    sendgrid_from_email = os.getenv("SENDGRID_FROM_EMAIL", "sarah@perenniaai.com")
...
async def test_email_send(to_email: str = "tloss@me.com"):
    ...
    try:
        ...
        return {
            "test_result": result,
            "to_email": to_email,
            "from_email": os.getenv("SENDGRID_FROM_EMAIL", "sarah@perenniaai.com"),
...
- Perennia AI Team
        ...
        if scheduled_start:
            try:
                organizer_email = team_member_email or os.getenv("SENDGRID_FROM_EMAIL", "sarah@perenniaai.com")
        ...
        if scheduled_start:
            try:
                ics_content = generate_ics_content(
                    ...
                    organizer_email=os.getenv("SENDGRID_FROM_EMAIL", "sarah@perenniaai.com"),
