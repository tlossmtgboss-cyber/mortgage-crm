"""
Scheduler OpenAPI Response Models
=================================
Pydantic response models for all scheduler endpoints.
Provides comprehensive OpenAPI documentation with examples, descriptions,
and type safety for enterprise API consumers.
