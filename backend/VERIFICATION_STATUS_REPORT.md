...
$ curl -s -o /dev/null -w "HTTP %{http_code}" -X POST \
  "https://api.perenniaai.com/api/v1/migrations/add-ai-receptionist-dashboard-tables"
...
- API documentation: https://api.perenniaai.com/docs#/AI%20Receptionist%20Dashboard
