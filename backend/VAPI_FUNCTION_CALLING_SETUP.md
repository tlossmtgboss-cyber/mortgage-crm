...
2. Set **Server URL** to:
   ```
   https://api.perenniaai.com/api/vapi/functions
   ```
...
```json
{
  ...
  "url": "https://api.perenniaai.com/api/vapi/functions/get-lead-info",
  "method": "POST"
}
```
...
```json
{
  ...
  "url": "https://api.perenniaai.com/api/vapi/functions/update-lead-status",
  "method": "POST"
}
```
...
```json
{
  ...
  "url": "https://api.perenniaai.com/api/vapi/functions/create-task",
  "method": "POST"
}
```
...
```json
{
  ...
  "url": "https://api.perenniaai.com/api/vapi/functions/schedule-appointment",
  "method": "POST"
}
```
...
```json
{
  ...
  "url": "https://api.perenniaai.com/api/vapi/functions/available-time-slots",
  "method": "GET"
}
```
...
- Test endpoints directly with curl:
  ```bash
  curl -X POST https://api.perenniaai.com/api/vapi/functions/get-lead-info \
